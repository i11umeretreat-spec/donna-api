...
//
// Окно «Память тела», трое суток, 17.09 17:00 — 20.09 17:00 по Женеве.
//
...
// поэтому 17:00 по Женеве это 15:00 UTC на обоих концах.
//
// Даты продублированы в test/pamyat-access.test.js строками, и это
// не оплошность: тот тест сверяет их со спекой операции и краснеет,
// если здесь правят одно, а в договорённости стоит другое.
const WINDOW_START = Date.UTC(2026, 8, 17, 15, 0, 0);
const WINDOW_END   = Date.UTC(2026, 8, 20, 15, 0, 0);
