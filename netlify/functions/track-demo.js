...
const VALID_EVENTS  = ['pageview', 'play', 'lead', 'welcome_play', 'flagship_preview_1_play', 'flagship_preview_2_play', 'demo_click', 'hero_preview_play', 'podbor_click', 'podbor_start', 'podbor_answer', 'podbor_complete', 'demo_complete'];
